...
Mistakes
--------
- Came up with inefficient solution. Couldn't spot overlapping subproblems and the necessity to use memoization.
- Used lru_cache decorator based on claude recommendation but there's a better solution.
- Didn't catch a very easy typo bug which said "elif s[0] == '*'"
'''
